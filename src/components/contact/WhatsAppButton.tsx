...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]">
      <Button
        size="lg"
        className="h-14 w-14 rounded-full shadow-2xl bg-[#25D366] text-white hover:bg-[#128C7E] transition-transform hover:scale-110 flex items-center justify-center p-0"

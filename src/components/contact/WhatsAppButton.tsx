...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]">
      <Button
        size="lg"
        className="h-14 w-14 rounded-full shadow-2xl transition-all hover:scale-110 flex items-center justify-center p-0 bg-[#25D366] text-white hover:bg-[#128C7E] border-none"
